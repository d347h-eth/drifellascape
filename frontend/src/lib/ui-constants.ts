...
export const TOGGLE_OVER_DOTS_OFFSET = 28; // px above pills when bar is visible

export const TRAIT_BOX_WIDTH = 150; // px
export const TRAIT_ARROW_PAD_TOTAL = 100; // two 50px pads

export const EDGE_NAV_HEIGHT = 1087; // px
