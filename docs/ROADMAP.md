...
- Progress
  ...
  - [x] Static serving via central Caddy: bundles from `releases/current`, images under `/static/art/...`; repo-local `caddy-verify` profile for side‑by‑side checks on `:42888`
